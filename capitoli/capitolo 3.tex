...
Real3D-AD \cite{liu2023real3dad} è il primo dataset composto esclusivamente da \textbf{point cloud ad alta precisione}, senza componente RGB.

Il suo obiettivo è superare le principali limitazioni di MVTec 3D-AD: precisione insufficiente, presenza di blind spots e assenza di point cloud veri (MVTec 3D-AD fornisce dati RGBD, definiti ``2.5D'').
