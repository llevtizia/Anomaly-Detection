...
Le metodologie di machine learning si dividono principalmente in due approcci, quello \textbf{supervisionato} e quello \textbf{non supervisionato} \cite{murphy2012}.
...
Tra gli algoritmi più utilizzati si annoverano la regressione lineare, la regressione ridge e lasso (per gestire la regolarizzazione, Shrinkage Methods), le reti neurali e metodi ensemble come random forests \cite{hastie2009}.
